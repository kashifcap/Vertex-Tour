...
// Used when guides are embeded in toursSchema but we switched to refrencing
// tourSchema.pre('save', async function (next) {
//   this.guidePromises = this.guides.map(async (el) => await User.findById(el));
