      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data);
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGVzdHVzZXIwODQ4IiwiYSI6ImNrcGkzajV2eDJ4YnkzMW54N2FtYm5hczkifQ.0ONxmV_L2hA8P1a_PgWmKQ';
...
var stripe = Stripe('pk_test_51J03cQSG53LP0FHORXCWBx0eMcrjreG53l2dqTrOds4cB2HBHFtgjuoT1i32ZNMTtO8rBIwrKQ0GGrXY00W44CCB00OsXPjnaE');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', _context.t0.reponse.data.message);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'data'); // setTimeout(() => {
    //   location.reload();
    // }, 1500);
  });
}
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(data, 'password');
  });
}
